...
def playback_dataset(hdf5_file: str, args, write_video: bool, src_path: str):
...
def main(args):
    ...
    if args.debug:
        for hdf5_file in tqdm(hdf5_files):
            playback_dataset(hdf5_file, args, write_video, src_path)
    else:
        process_map(
            partial(playback_dataset, args=args, write_video=write_video, src_path=src_path),
            hdf5_files,
